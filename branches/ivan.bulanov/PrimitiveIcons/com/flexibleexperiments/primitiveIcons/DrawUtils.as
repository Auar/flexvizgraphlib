...
package com.flexibleexperiments.primitiveIcons
{
	...
	public class DrawUtils
	{
		...
		* draws circle.
		*/
		public static function circle(target:UIComponent, x:Number, y:Number, z:Number):void
		{
			
			target.graphics.moveTo(x, y);
			target.graphics.drawCircle(x, y, z);
			
			
		}
		
		public static function rectangle(target:UIComponent, x:Number, y:Number, width:Number, height:Number):void
		{
			target.graphics.moveTo(x, y);
